...
namespace CtpSvr
{
    ...
    public class CtpWikiProxy : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            WikiArticle article = WikiArticleFactory.CreateWikiArticle("Taipei", "en");
            ...
            response.RawData = HttpUtility.UrlEncode(DataUtil.RemoveHtmlTagFromString(response.RawData.ToString()));
